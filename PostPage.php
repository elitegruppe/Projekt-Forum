<?php
	require_once('configPostPage.php');
	$db = new forumModel();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title><?php echo $sitename ?>PostSite</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        ...
        <p class="lead blog-description">Ihr IT-Einsteigerforum f&uumlr alle die Hilfe ben&oumltigen oder leisten wollen.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title"><?php echo $kategorie ?></h2>
